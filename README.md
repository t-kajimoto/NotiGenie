...
- **[システムアーキテクチャ](./docs/02_設計/システムアーキテクチャ.md)**: システム全体の構成図と各コンポーネントの役割について説明しています。
- **[LLM対話フロー設計](./docs/02_設計/LLM対話フロー設計.md)**: LLMが使用するツール（関数）の詳細と、Notion APIとの対応関係について説明しています。
- **[デプロイと運用ガイド](./docs/03_開発運用/デプロイと運用ガイド.md)**: デプロイ手順や、新しいNotionデータベースを連携させる方法について説明しています。

## 🚀 自分の環境へのデプロイ

このプロジェクトを自身の環境にデプロイする方法は、**[デプロイと運用ガイド](./docs/03_開発運用/デプロイと運用ガイド.md)** を参照してください。
ガイドには、以下の内容が含まれています。
