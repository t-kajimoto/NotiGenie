...
import json
from domain.use_cases.interpret_and_execute import INotionClientGateway

class NotionClientGateway(INotionClientGateway):
    def __init__(self, notion_api_key: str, notion_database_mapping: dict):
